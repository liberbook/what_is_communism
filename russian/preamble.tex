...
\hypersetup{
  ...
  linkcolor=black,
  urlcolor=blue,
  pdftitle={Что такое коммунизм?},
  pdfauthor={Группа Энгельс},
  pdfsubject={Теория коммунизма},
  pdfkeywords={коммунизм, марксизм, Маркс, Энгельс, Ленин},
  pdfencoding=auto,
  unicode=true,
}
...
% No chapter numbering in TOC for this unnumbered work
